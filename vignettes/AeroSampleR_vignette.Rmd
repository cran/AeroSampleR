...
and [Pui](https://doi.org/10.1080/02786828708959166) bend models are used in this package.
...
Calculate the efficiency of the bend. Here, we'll take the Zhang model option. Bend Efficiency is found via the `bend_eff()` function and is where you will choose to use one of three different tube models {Zhang (the default), or Pui}. The bend angle and element number are also listed in the function.
...
shorter, but is considered superseded by micrometers) 
